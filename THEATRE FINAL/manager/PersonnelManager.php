...
class PersonnelManager extends AbstractManager
{
    ...
    function listerPersonnel($titre){
        $sql="select o.titre, psl.nom as 'Nompersonnel', psl.prenom as 'Prenompersonnel', psl.fonction,
	          psn.nom as 'Nompersonnage', psn.prenom as 'Prenompersonnage'
              from personnel as psl 
              inner join organiser as o on psl.id=o.id
              left join personnages as psn on psl.id=psn.id
              where o.titre=:titre";
