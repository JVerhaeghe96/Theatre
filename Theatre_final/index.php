...
if(!isset($_SESSION["connection"])){    //  page de connexion
   echo" <h1>CONNEXION</h1>";
    ...
    if(!isset($_GET["action"])){ //  page d'accueil
        echo "
            <table>
                ...
                <tr>
                    <td>
                        <img src=\"image/administration.png\"/><br/>
                        <a href=\"index.php?action=admin\"><img src=\"image/gestionUtilisateurs.png\"/></a><br/>
                        <a href=\"index.php?action=archive\"><img src=\"image/archivage.png\"/></a>
                    </td>
                    <td>
                        Ajouter rang utilisateur, modifier droits des utilisateurs<br/>
                        Archiver les données relatives à un spectacle
                    </td>
                </tr>
    ...
    if($_GET["action"] == "archive"){ // page archive
        if(unserialize($_SESSION['connection'])->getLogin()=='admin'){  // si l'utilisateur a le droit d'accès
            // connexion DB
