...
if(!isset($_GET['action']) || !isset($_POST["nom"]) || !isset($_POST["prenom"])){
    header("HTTP/1.1 403");
}else {
        $dbManager = new DBManager();
        $pdo = $dbManager->connect();
    if($_GET["action"]=="reservation" && isset($_POST["titre"]) && isset($_POST["date"]) && isset($_POST["numReservation"]) && $_POST["titre"] != "" && $_POST["date"] != ""){
