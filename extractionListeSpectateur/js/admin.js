$(document).ready(function(){
    ...
    $("#boutonAddRang").on("click", function(){ //  Affiche le formulaire pour ajouter un utilisateur et assombrit l'arrière-plan
        $("#modal").fadeIn("slow");
        $("#formNewUser").fadeIn("slow");
    });

    $("#closeButton").on("click", function(){  //  permet de fermer le formulaire d'ajout d'un utilisateur
        $("#modal").fadeOut("slow");
