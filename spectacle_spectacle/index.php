...
if(!isset($_SESSION["connection"])){    //  page de connexion
    ...
    <table>
    ...
    else if($_GET["action"]=="admin"){  //  page administration
        if(isset($_GET["error"])) {
        ...
        <div id=\"content\">
			...
			<div class=\"formAdd content2\" id=\"acteur\">
				...
				<button id=\"addActeurDB\" value=\"ajouter acteur\">Ajouter personnel</button>
			</div>
        ";
    }
}
